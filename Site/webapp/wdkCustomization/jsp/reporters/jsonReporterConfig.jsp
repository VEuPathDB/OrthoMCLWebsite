      ...
      <c:otherwise>
        ...
        <!-- content of current page -->
                ...
                <c:set var="numCols" value="2"/>
				        <table>
				          <imp:attributeColumns title="Attributes" numCols="${numCols}" attributes="${wdkAnswer.allReportMakerAttributes}"/>
				          <imp:attributeColumns title="Tables" numCols="${numCols}" attributes="${wdkAnswer.allReportMakerTables}"/>
				        </table>
				      </td>
				    </tr>
				    <tr>
