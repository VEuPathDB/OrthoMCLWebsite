...
-----------------------------------------------*/
	...
	dqm__main_bgcolor = "#444488"		//default color for all items, HEX or 'transparent'
	dqm__main_bgcolorX = "#444488"		//specific menu item color, HEX or 'transparent'
...
-----------------------------------------------*/
	...
	dqm__maindesc1 = "About OrthoMCL"
	dqm__micon_index1 = 0
	dqm__url1 = "/cgi-bin/OrthoMclWeb.cgi?rm=orthomcl"



    //Main Menu 2

	dqm__maindesc2 = "Database"
	dqm__micon_index2 = 0
	dqm__url2 = "/cgi-bin/OrthoMclWeb.cgi?rm=genome"



    //Main Menu 3

	dqm__maindesc3 = "Search"
	dqm__micon_index3 = 0
	dqm__url3 = ""; // "/cgi-bin/OrthoMclWeb.cgi?rm=search"
...
----------------------------------------------*/
	...
	dqm__subdesc3_0 = "Search Sequence"
	dqm__subdesc3_1 = "Search Group"
	
	dqm__icon_index3_0 = 0
	dqm__icon_index3_1 = 0
	
	dqm__url3_0 = ""; // "/cgi-bin/OrthoMclWeb.cgi?rm=search"
	dqm__url3_1 = "";// "/cgi-bin/OrthoMclWeb.cgi?rm=sequenceQueryHistory"
	...
	dqm__url3_0_0 = "/cgi-bin/OrthoMclWeb.cgi?rm=sequenceQueryForm&type=ackeyword"
	dqm__url3_0_1 = "/cgi-bin/OrthoMclWeb.cgi?rm=sequenceQueryForm&type=blast"
	dqm__url3_0_2 = "/cgi-bin/OrthoMclWeb.cgi?rm=sequenceQueryHistory"

    //Sub Menu 3_1

	dqm__sub_xy3_1 = "-14,2"
	dqm__sub_menu_width3_1 = 200

	dqm__subdesc3_1_0 = "By Accession / Keyword"
	...
	dqm__url3_1_0 = "/cgi-bin/OrthoMclWeb.cgi?rm=groupQueryForm&type=ackeyword"
	dqm__url3_1_1 = "/cgi-bin/OrthoMclWeb.cgi?rm=groupQueryForm&type=property"
	dqm__url3_1_2 = "/cgi-bin/OrthoMclWeb.cgi?rm=groupQueryForm&type=ppexpression"
	dqm__url3_1_3 = "/cgi-bin/OrthoMclWeb.cgi?rm=groupQueryForm&type=ppform"
	dqm__url3_1_4 = "/cgi-bin/OrthoMclWeb.cgi?rm=groupQueryHistory"
